...
pub fn build(b: *std.Build) !void {
    ...
    try sources.appendSlice(&.{
        ...
        .{ .name = "ggml_cpp", .source_file = "llama.cpp/ggml/src/ggml.cpp" },
        .{ .name = "ggml_threading", .source_file = "llama.cpp/ggml/src/ggml-threading.cpp" },
        .{ .name = "ggml_opt", .source_file = "llama.cpp/ggml/src/ggml-opt.cpp" },
        ...
        .{ .name = "llama_arch", .source_file = "llama.cpp/src/llama-arch.cpp" },
        .{ .name = "llama_batch", .source_file = "llama.cpp/src/llama-batch.cpp" },
        .{ .name = "llama_chat", .source_file = "llama.cpp/src/llama-chat.cpp" },
        .{ .name = "llama_context", .source_file = "llama.cpp/src/llama-context.cpp" },
        .{ .name = "llama_cparams", .source_file = "llama.cpp/src/llama-cparams.cpp" },
        .{ .name = "llama_grammar", .source_file = "llama.cpp/src/llama-grammar.cpp" },
        .{ .name = "llama_graph", .source_file = "llama.cpp/src/llama-graph.cpp" },
        .{ .name = "llama_hparams", .source_file = "llama.cpp/src/llama-hparams.cpp" },
        .{ .name = "llama_impl", .source_file = "llama.cpp/src/llama-impl.cpp" },
        .{ .name = "llama_io", .source_file = "llama.cpp/src/llama-io.cpp" },
        .{ .name = "llama_kv_cache_unified", .source_file = "llama.cpp/src/llama-kv-cache-unified.cpp" },
        .{ .name = "llama_kv_cache_unified_iswa", .source_file = "llama.cpp/src/llama-kv-cache-unified-iswa.cpp" },
        .{ .name = "llama_memory", .source_file = "llama.cpp/src/llama-memory.cpp" },
        .{ .name = "llama_memory_hybrid", .source_file = "llama.cpp/src/llama-memory-hybrid.cpp" },
        .{ .name = "llama_memory_recurrent", .source_file = "llama.cpp/src/llama-memory-recurrent.cpp" },
        .{ .name = "llama_mmap", .source_file = "llama.cpp/src/llama-mmap.cpp" },
        .{ .name = "llama_model", .source_file = "llama.cpp/src/llama-model.cpp" },
        .{ .name = "llama_model_loader", .source_file = "llama.cpp/src/llama-model-loader.cpp" },
        .{ .name = "llama_model_saver", .source_file = "llama.cpp/src/llama-model-saver.cpp" },
        .{ .name = "llama_quant", .source_file = "llama.cpp/src/llama-quant.cpp" },
        .{ .name = "llama_sampling", .source_file = "llama.cpp/src/llama-sampling.cpp" },
        .{ .name = "llama_vocab", .source_file = "llama.cpp/src/llama-vocab.cpp" },
